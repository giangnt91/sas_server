...
sas.use(function (req, res, next) {
	...
	var allowedOrigins = ['http://112.78.1.78:199', 'http://localhost:8080', 'http://sascenter.net', 'http://booking.sas.edu.vn', 'http://booking.sascenter.net'];
...
io.on('connection', function (socket) {
	setInterval(function () {
		...
		student_model.find({
			'Appointment_time.name': _time,
			'Appointment_day': _day
		}, function (err, data) {
			if (err) {
				console.log('Appointment_time sas ' + err);
			} else {
